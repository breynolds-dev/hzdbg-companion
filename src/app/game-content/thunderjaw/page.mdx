import { boxArt } from "@/data/thunderjaw"
import Image from 'next/image'

export const metadata = {
  title: 'The Thunderjaw Expansion',
  description: 'Information about the Thunderjaw Expansion for Horizon Zero Dawn: The Board Game.',
}

# The Thunderjaw Expansion
