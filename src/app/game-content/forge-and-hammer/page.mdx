import { boxArt } from "@/data/forge-and-hammer"
import Image from 'next/image'

export const metadata = {
  title: 'The Forge & Hammer Expansion',
  description: 'Information about the Forge & Hammer Expansion for Horizon Zero Dawn: The Board Game.',
}

# The Forge & Hammer Expansion
