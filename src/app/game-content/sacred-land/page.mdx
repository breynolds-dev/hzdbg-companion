import { boxArt } from "@/data/sacred-land"
import Image from 'next/image'

export const metadata = {
  title: 'The Sacred Land Expansion',
  description: 'Information about the Sacred Land Expansion for Horizon Zero Dawn: The Board Game.',
}
