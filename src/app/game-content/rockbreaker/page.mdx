import { boxArt } from "@/data/rockbreaker"
import Image from 'next/image'

export const metadata = {
  title: 'The Rockbreaker Expansion',
  description: 'Information about the Rockbreaker Expansion for Horizon Zero Dawn: The Board Game.',
}

# The Rockbreaker Expansion
