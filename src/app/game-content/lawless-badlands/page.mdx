import { boxArt } from "@/data/lawless-badlands"
import Image from 'next/image'

export const metadata = {
  title: 'The Lawless Badlands Expansion',
  description: 'Information about the Lawless Badlands Expansion for Horizon Zero Dawn: The Board Game.',
}
