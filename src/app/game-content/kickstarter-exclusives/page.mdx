import { boxArt } from "@/data/kickstarter-exclusives"
import Image from 'next/image'

export const metadata = {
  title: 'The Kickstarter Exclusives',
  description: 'Information about the Kickstarter Exclusives for Horizon Zero Dawn: The Board Game.',
}
