import { boxArt } from "@/data/soldiers-of-the-sun"
import Image from 'next/image'

export const metadata = {
  title: 'The Soldiers of the Sun Expansion',
  description: 'Information about the Soldiers of the Sun Expansion for Horizon Zero Dawn: The Board Game.',
}
