import { boxArt } from "@/data/heart-of-the-nora"
import Image from 'next/image'

export const metadata = {
  title: 'The Heart of the Nora Expansion',
  description: 'Information about the Heart of the Nora Expansion for Horizon Zero Dawn: The Board Game.',
}

# The Heart of the Nora Expansion
