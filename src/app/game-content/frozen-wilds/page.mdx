import { boxArt } from "@/data/frozen-wilds"
import Image from 'next/image'

export const metadata = {
  title: 'The Frozen Wilds Expansion',
  description: 'Information about the Frozen Wilds Expansion for Horizon Zero Dawn: The Board Game.',
}
